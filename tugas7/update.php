    ...
    <form action="" method="POST">
        <ul>
            ...
            <li>
                ...
                <input type="date" name="tgl_lhr" id="tgl_lhr" required value="<?= htmlspecialchars($tanggal_lahir) ?>"><br>
            </li>
            <li>
        ...
        <button onclick="window.location.href='index.php';" id="back" name="back">Back</button>
        </span>
    </form>
</body>
</html>